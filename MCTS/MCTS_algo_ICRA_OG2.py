...
class multi_level_MCTS_algo_OG2():
    ...
    def init_MCTS(self):
        MCTS_ins = MCTS_algo_OG2(deepcopy(self.curr_config_), deepcopy(self.goal_config_), self.scene_info, swept_volume1=self.swept_volume1, swept_volume2=self.swept_volume2, obj_mesh=self.obj_mesh, target_pos=self.target_pos, unknown_area=self.unknown_area, valid_area=self.valid_area, potential_centers=self.potential_centers)
