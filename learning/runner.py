...
from SceneDataLoader_object_focus import SceneDataset_object_focus
...
def feed_forward(scene, camera_pose):
    ...
    model.load_state_dict(torch.load('/home/j0k/Project/Imsa/learning/saved_MODEL/CamScoreNet_best.pth'))
    model.eval()
